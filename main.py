...
features_pmbh = features_ensemble + features_BH_output
model_manager.add_model("pmbh", features_pmbh)
...
# print("\nHerbert Formula")
# print(model_manager.get_logistic_regression_formula('hertbert'))
# model_manager.plot_roc_curves('herbert')
# model_manager.generate_shap_plot('herbert', features_herder)
...
print("\npmbh Formula")
print(model_manager.get_logistic_regression_formula('pmbh'))
model_manager.plot_roc_curves('pmbh')
model_manager.generate_shap_plot('pmbh', features_brock)
model_manager.plot_prediction_histograms('pmbh')
...
# voting_model = VotingModel(trained_models, features_ensemble, filepath, target, binary_map, 'ENSEMBLE INPUT', threshold_metric='npv')
# voting_model.reset()
